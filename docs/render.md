...
- `worker`: long-running agent jobs such as reading Notion/GitHub/Slack context, generating job listings, ranking candidates, summarizing interviews, and publishing/refreshing the org's own Yougrep job board postings.
